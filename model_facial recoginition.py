...
data_path='C:/Users/WELCOME/Desktop/python/rcvdata/'
...
while True:
    ...
    try:
        ...
        if result[1]<500:
            ...
            if((confidence>15)and(confidence < 40)):
                cv2.putText(image,"sad",(250,450),cv2.FONT_HERSHEY_COMPLEX,1,(0,255,0),2)
                cv2.imshow('Face Cropper',image)
                counts= counts+1
            elif(confidence<=15):
                cv2.putText(image,"happy",(250,450),cv2.FONT_HERSHEY_COMPLEX,1,(0,255,0),2)
                cv2.imshow('Face Cropper',image)
                counth = counth+1
    except:
...
b =(counts+counth)/2
if(b>counts):
    print("***Yoo Dude you are Brave person!! Always be HAAPPY Dude***")
    webbrowser.open("https://www.youtube.com/watch?v=Vi2Lpp7HE8M")    
elif(b>counth):
    print("***YES!! I WILL DO IT***")
    webbrowser.open("https://www.youtube.com/watch?v=iCPN9E8eFZo")
